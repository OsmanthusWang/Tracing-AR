     ...
     //   imageView = (ImageView) findViewById(R.id.image_view);
        ...
        login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
              ...
              request.post(MainActivity.BASEURL+"login_check.php",User.class,new my_CallBackListener<User>() {
                        @Override
                    public void onSuccessResponse(User response) {
                        ...
                        if (response!=null) {
                            ...
                            if(rememberPass.isChecked()){//检查"记住密码"的复选框是否被选中
                                ...
                                editor.putString("icon_url",MainActivity.BASEURL+"img/usericon/"+response.getId()+".jpg");
